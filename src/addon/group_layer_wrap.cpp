...
Napi::Object GroupLayerWrap::NewInstance(Napi::Env env, nle_sdk::GroupLayer *group,
...
GroupLayerWrap::GroupLayerWrap(const Napi::CallbackInfo &info) : Napi::ObjectWrap<GroupLayerWrap>(info) {
}

nle_sdk::GroupLayer *GroupLayerWrap::getGroup(Napi::Env env) {
